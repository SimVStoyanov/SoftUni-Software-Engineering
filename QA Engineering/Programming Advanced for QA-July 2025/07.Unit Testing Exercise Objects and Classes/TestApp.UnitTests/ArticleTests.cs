...
public class ArticleTests
{
    ...
    public void Test_AddArticles_ReturnsArticleWithCorrectData()
    {
        ...
        {
            "Elon_Musk Instagram... Diyan_Apostolov",
        ...
        Assert.That(result.ArticleList[0].Author, Is.EqualTo("Diyan_Apostolov"));
    ...
    public void Test_GetArticleList_SortsArticlesByTitle()
    {
        ...
        string[] articles = new string[]
       {
        ...
        string expected = $"Car_maker_Stellantis - The_company_behind_the_brands_Vauxhall...: Rachel_Clun" +
            $"{Environment.NewLine}Elon_Musk - Instagram...: Diyan_Apostolov" +
