...
#print(f"Positive: {', '.join(number for number in number_as_string if int(number) >= 0)}")
#print(f"Negative: {', '.join(number for number in number_as_string if int(number) < 0)}")
#print(f"Even: {', '.join(number for number in number_as_string if int(number) % 2 == 0)}")
#print(f"Odd: {', '.join(number for number in number_as_string if int(number) % 2 != 0)}")
